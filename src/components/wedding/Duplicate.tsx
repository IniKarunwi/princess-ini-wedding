...
export default function Duplicate({ onRegistry }: DuplicateProps) {
  return (
    <motion.div
      ...
      >
        <motion.div variants={staggerContainer} initial="hidden" animate="visible">
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            We've already received your RSVP — no need to submit again.
            <br /><br />
            We can't wait to celebrate with you on the 26th!
          </motion.p>
